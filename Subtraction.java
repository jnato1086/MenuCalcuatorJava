...
public class Subtraction {
    ...
    public static void main(String[] args) {
        ...
        JLabel heading2 = new JLabel("Subtraction of Numbers");
        ...
        JLabel q3 = new JLabel("Difference:");
        ...
        heading2.setFont(new Font("Arial", Font.ITALIC, 25));
        ...
        btn1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    int minuend = Integer.parseInt(field1.getText());
                    int subtrahend = Integer.parseInt(field2.getText());
                    int difference = minuend - subtrahend;
                    field3.setText(Integer.toString(difference));
