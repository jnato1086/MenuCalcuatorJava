...
public class Division {
    ...
    public static void main(String[] args) {
        ...
        JLabel heading2 = new JLabel(" Division of Numbers ");
        ...
        heading2.setFont(new Font("Arial", Font.ITALIC, 30));
        ...
        btn1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    int dividend = Integer.parseInt(field1.getText());
                    int divisor = Integer.parseInt(field2.getText());
                    if (divisor != 0) {
                        int quotient = dividend / divisor;
                        field3.setText(Integer.toString(quotient));
                    } else {
                        field3.setText("Division by zero is not allowed");
                    }
