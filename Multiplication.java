...
public class Multiplication {
    ...
    public static void main(String[] args) {
        ...
        JLabel heading2 = new JLabel("Multiplication of Numbers");

        // All Components on the left Side
        JLabel q1 = new JLabel("First Number:");
        JTextField field1 = new JTextField(10);
        JLabel q2 = new JLabel("First  Number:");
        JTextField field2 = new JTextField(10);
        JLabel q3 = new JLabel("Product:");
        ...
        btn1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    int factor1 = Integer.parseInt(field1.getText());
                    int factor2 = Integer.parseInt(field2.getText());
                    int product = factor1 * factor2;
                    field3.setText(Integer.toString(product));
